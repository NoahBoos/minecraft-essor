...
public class ActionBar {
    public static void DisplayXPCount(ServerPlayer player, ItemStack itemInHand) {
        ...
        String experienceProgressCount = Component.translatable("translation.level").getString() + " " + equipmentLevelingData.GetLevel() + " - " + equipmentLevelingData.GetCurrentExperience() + " / " + equipmentLevelingData.GetRequiredExperienceToLevelUp();
